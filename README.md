...
| [twzrd-intel/agent-intel-mcp](https://intel.twzrd.xyz) | ![](https://img.shields.io/badge/twzrd-agent--intel-blue?style=flat-square) | `Community` | '26.04 | Solana on-chain trust scoring for AI agents. Verify wallet reputation before x402 micropayments. Remote MCP |
